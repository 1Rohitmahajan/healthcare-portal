...
SECRET_KEY = 'django-insecure-#7un8!__dl-(32-2z!ro#gydlg=eipymy_@klqaezq_3nh49*='
...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic', #make change
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',#make change
